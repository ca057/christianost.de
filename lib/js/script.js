/*
 * First draft of function, at the moment more a playground than a real implementation.
 */
function setTextToFullWidth(className) {
    ...
    var computeAndSetFontSize = function (elem) {
        ...
        // var pW = document.getElementById("wrapper").offsetWidth / elem.textContent.length;
...
/*
 * Improved implementation of above function, 
 * trying to improve also performance on resizing by 
 * reducing the numbers of calculations done for each adaption.
 * Still more improvements need to be done.
 */
